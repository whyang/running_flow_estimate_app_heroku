...
###
# /tribe/100_107/<string:tribe> query one specific tribe's variation info. of the indigenous population 
#
@_ns_tribe.route('/100_107/<string:tribe>')
...
class AreaList_100_107(Resource):
    ...
    def get(self):
        '''查詢原住民族人口統計數據，在各縣市的年度變動數量 (100年~107年)'''            
        ###
        # read the data between the year of 100 and 107
        #
        with open('..\\data\\population-var-100-107.csv', 'r', encoding='utf-8', newline='') as csvfile:
...
###
# /area/100_107/<string:area> query the tribes' variation info. of the indigenous population in the specific area (city/county) 
#
@_ns_area.route('/100_107/<string:area>')
